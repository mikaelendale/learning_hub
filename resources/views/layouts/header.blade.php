<!-- Header -->
        <header
            class="flex items-center transition-[height] shrink-0 bg-[#fefefe] dark:bg-coal-500 h-[--tw-header-height]"
            data-sticky="true"
                    ...
                    <div
                        ...
                        <a href="index.html">
                            <img class="default-logo min-h-[22px] max-w-none"
                                src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/app/mini-logo-gray.svg" />
                        </a>
                    </div>
                                ...
                                <div class="menu-dropdown w-48 py-2">
                                    <div class="menu-item">
                                        <a class="menu-link gap-1.5 pb-2 lg:pb-4 px-2"
                                            href="public-profile/profiles/default.html" tabindex="0">
                                            <span
                                    ...
                                    <div class="menu-item active">
                                        <a class="menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="index.html" tabindex="0">
                                            <span
                                                class="menu-title text-nowrap font-medium text-sm text-gray-700 menu-item-active:text-primary menu-item-active:font-semibold menu-item-here:text-primary menu-item-here:font-semibold menu-item-show:text-primary menu-link-hover:text-primary">
                                                <span class="menu-icon">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="network/get-started.html"
                                            tabindex="0">
                                            <span
                                                class="menu-title text-nowrap font-medium text-sm text-gray-700 menu-item-active:text-primary menu-item-active:font-semibold menu-item-here:text-primary menu-item-here:font-semibold menu-item-show:text-primary menu-link-hover:text-primary">
                                                <span class="menu-icon">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link gap-1.5 pb-2 lg:pb-4 px-2"
                                            href="authentication/get-started.html" tabindex="0">
                                            <span
                                                class="menu-title text-nowrap font-medium text-sm text-gray-700 menu-item-active:text-primary menu-item-active:font-semibold menu-item-here:text-primary menu-item-here:font-semibold menu-item-show:text-primary menu-link-hover:text-primary">
                                                <span class="menu-icon">
                    ...
                    <div class="flex items-center gap-1">
                        <div class="dropdown" data-dropdown="true" data-dropdown-offset="115px, 10px"
                            ...
                            <button
                                ...
                                <i class="ki-filled ki-notification-status text-gray-600">
                                </i>
                            </button>
                                                    ...
                                                    <div class="flex flex-col gap-3.5 grow">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="flex items-center gap-1.5">
                                                                <img class="h-6"
                                                                    src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/file-types/xls.svg" />
                                                ...
                                                <div class="flex grow gap-2.5 px-5">
                                                    ...
                                                    <div class="flex flex-col gap-3.5 grow">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="flex items-center gap-1.5">
                                                                <img class="h-6"
                                                                    src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/file-types/word.svg" />
                                                                <div class="flex flex-col gap-0.5">
                                                                    <a class="hover:text-primary-active font-medium text-gray-700 text-xs"
                                                                        href="#">
                                                                        Landing-page.docx
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="flex items-center gap-1.5">
                                                                <img class="h-6"
                                                                    src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/file-types/svg.svg" />
                                                                <div class="flex flex-col gap-0.5">
                                                                    <a class="hover:text-primary-active font-medium text-gray-700 text-xs"
                                                                        href="#">
                                                                        New-icon.svg
                        ...
                        <div class="dropdown" data-dropdown="true" data-dropdown-offset="75px, 10px"
                            data-dropdown-placement="bottom-end" data-dropdown-trigger="click|lg:click">
                            <button
                                class="dropdown-toggle btn btn-icon btn-icon-lg size-9 rounded-full hover:bg-primary-light hover:text-primary dropdown-open:bg-primary-light dropdown-open:text-primary text-gray-600">
                                <i class="ki-filled ki-messages text-gray-600">
                                </i>
                            </button>
                                                ...
                                                <div class="menu" data-menu="true">
                                                    <div class="menu-item" data-menu-item-offset="0, 10px"
                                                        ...
                                                        <div class="menu-dropdown menu-default w-full max-w-[175px]"
                                                            ...
                                                            <div class="menu-item">
                                                                <a class="menu-link"
                                                                    href="account/security/privacy-settings.html">
                                                                    <span class="menu-icon">
                                        ...
                                        <div class="flex items-end justify-end gap-3.5 px-5">
                                            <div class="flex flex-col gap-1.5">
                                                ...
                                                <div class="flex items-center justify-end relative">
                                                    ...
                                                    <i
                                                        class="ki-filled ki-double-check text-lg absolute text-gray-400">
                                                    </i>
                                                </div>
                                            </div>
                                            <div class="relative shrink-0">
                    ...
                    <div class="menu" data-menu="true">
                        <div class="menu-item" data-menu-item-offset="20px, 10px"
                            ...
                            <div class="menu-toggle btn btn-icon rounded-full">
                                <img alt=""
                                    class="size-9 rounded-full justify-center rounded-full border border-gray-500 shrink-0"
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link h-10" href="#">
                                                    <span class="menu-icon">
                                                        <img alt="" class="inline-block size-4 rounded-full"
                                                            src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/flags/france.svg" />
                                                    </span>
                                                    <span class="menu-title">
                                                        French
                                                    </span>
