...
<body class="bg-white">
                ...
                <div class="max-w-2xl lg:py-6 mx-auto uk-switcher" id="course-tabs">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-x-4 mb-5">
                            <img src="demo/assets/images/avatars/avatar-4.jpg" alt="" class="rounded-full shadow w-12 h-12">
                            <div>
    ...
    <!-- Javascript
    ================================================== -->
    <script src="{{asset('demo/code.jquery.com/jquery-3.6.0.min.js')}}" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
