                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="text-2sm font-medium text-gray-700">
                                    {{ ucfirst($classAttended) }} class offers tailored learning materials and exclusive
                                    content to help you enhance your skills.
                                </div>
                            </div>
                        </div>
                            ...
                            <form action="{{ route('subscription.upgrade') }}" method="POST">
                                ...
                                @if ($classAttended !== 'Advanced')
                                    <button class="btn btn-sm btn-dark" type="submit">
                                        Upgrade to {{ $classAttended === 'Beginner' ? 'Intermediate' : 'Advanced' }}
                                    </button>
                                @else
